...
func TestGovernanceMethods() {
	...
	testframework.TFramework.RegTestCase("RegisterRipple", RegisterRipple)
	...
	testframework.TFramework.RegTestCase("UpdateRipple", UpdateRipple)
	testframework.TFramework.RegTestCase("ApproveUpdateSideChain", ApproveUpdateSideChain)
	testframework.TFramework.RegTestCase("RegisterAsset", RegisterAsset)
	...
	testframework.TFramework.RegTestCase("QueryRelayer", QueryRelayer)
